    ...
    rsx! {
        tr { class: "hover:bg-slate-50 transition-colors",
            ...
            td { class: "px-6 py-4 text-center",
                span { class: if is_admin { "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-red-100 text-red-600 border border-red-200" } else { "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-slate-100 text-slate-600 border border-slate-200" },
            ...
            td { class: "px-6 py-4 text-right",
                div { class: "flex justify-end gap-2",
                    ...
                    button {
                        class: if is_admin { "px-3 py-1.5 bg-slate-200 hover:bg-slate-300 text-slate-700 rounded-lg text-xs font-bold transition-colors flex items-center gap-1.5" } else { "px-3 py-1.5 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg text-xs font-bold transition-colors border border-red-200 flex items-center gap-1.5" },
