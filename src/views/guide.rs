                ...
                div { class: "grid grid-cols-1 md:grid-cols-2 gap-6",
                    ...
                    div { class: "bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-md transition-shadow relative overflow-hidden group",
                        ...
                        div { class: "relative z-10",
                            ...
                            h2 { class: "text-xl font-bold text-slate-800 dark:text-slate-200 mb-3",
                    ...
                    div { class: "bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-md transition-shadow relative overflow-hidden group",
                        ...
                        div { class: "relative z-10",
                            div { class: "w-12 h-12 bg-emerald-100 text-emerald-600 rounded-2xl flex items-center justify-center text-2xl mb-6 shadow-sm",
                                "🎙️"
                            }
                            h2 { class: "text-xl font-bold text-slate-800 dark:text-slate-200 mb-3",
                                "2. Voice Chat & Speech Scoring"
                            }
                            p { class: "text-slate-600 dark:text-slate-400 text-sm leading-relaxed",
                    ...
                    div { class: "bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-md transition-shadow relative overflow-hidden group",
                        ...
                        div { class: "relative z-10",
                            div { class: "w-12 h-12 bg-fuchsia-100 text-fuchsia-600 rounded-2xl flex items-center justify-center text-2xl mb-6 shadow-sm",
                                "⚔️"
                            }
                            h2 { class: "text-xl font-bold text-slate-800 dark:text-slate-200 mb-3",
                                "6. Mode Sosial & Beranda Feed"
                            }
                            p { class: "text-slate-600 dark:text-slate-400 text-sm leading-relaxed",
