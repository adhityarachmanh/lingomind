      ...
      <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-xl shadow-xl max-w-md w-full border border-slate-200 dark:border-slate-700 text-center">
        ...
        {state.message ? (
          <div className="py-6">
            ...
            <Link href="/login" className="block w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-3 px-4 rounded-xl transition-all shadow-md hover:shadow-card-hover">
